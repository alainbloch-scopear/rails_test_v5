...
class CatsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create cat" do
    assert_difference('Cat.count') do
      post cats_url, params: { cat: { description: @cat.description, name: @cat.name, user: @cat.user } }
    end
  ...
  test "should update cat" do
    patch cat_url(@cat), params: { cat: { description: @cat.description, name: @cat.name, user: @cat.user } }
